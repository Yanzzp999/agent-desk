...
| `create_agentdesk_task` | Use Codex CLI to generate `.agent-desk/tasks/<taskId>/task.md`; similar tasks return clear recovery choices before duplicate creation. Failed matches keep their logs, and rebuilding links them to the replacement task. |
